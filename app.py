...
class App(threading.Thread):
    ...
    def __init__(self):
        ...
        board_info["kernel"] = board_info.get("kernel", "") + " " + subprocess.check_output(["uname", "-v"]).decode(
            "utf-8")
    ...
    def get_clients(self):
        mock = False
        mock_clients_data = {'freq': 2457, 'clients': {
            '7c:03:ab:48:31:6c': {'auth': True, 'assoc': True, 'authorized': True, 'preauth': False, 'wds': False,
                                  'wmm': True, 'ht': True, 'vht': False, 'he': False, 'wps': False, 'mfp': False,
                                  'rrm': [0, 0, 0, 0, 0], 'aid': 2, 'bytes':
                                      {'rx': 22556457, 'tx': 318005089}, 'airtime': {'rx': 0, 'tx': 460871086},
                                  'packets': {'rx': 158290, 'tx': 245375}, 'rate':
                                      {'rx': 1000, 'tx': 1000}, 'signal': -41, 'capabilities': {}},
            'e4:42:a6:56:4e:e7': {'auth': True, 'assoc': True, 'authorized': True,
                                  'preauth': False, 'wds': False, 'wmm': True, 'ht': True, 'vht': False, 'he': False,
                                  'wps': False, 'mfp': False, 'rrm': [0, 0, 0, 0, 0],
                                  'aid': 1, 'bytes': {'rx': 4549039, 'tx': 120524910},
                                  'airtime': {'rx': 0, 'tx': 174426269}, 'packets': {'rx': 41293, 'tx': 91143},
